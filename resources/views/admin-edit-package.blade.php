                            ...
                            <div class="border p-3 rounded">
                                <form class="row g-3" action="{{route('update-package')}}" method="post" enctype="multipart/form-data">
                                   ...
                                   <div class="col-12">
                                    ...
                                    <br>
                                    <input required type="radio" value='National' name="pack_type" @php if($data['pack_type'] == 'National'){echo "checked";}@endphp> 
                                    <span class="form-label">National</span>
                                    <input required type="radio" value='International' name="pack_type"@php if($data['pack_type'] == 'International'){echo "checked";}@endphp> 
                                    <span class="form-label">International</span>
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">Package title</label>
                                        <input required type="text" name="pack_title" class="form-control" placeholder="Package Title" value = "{{$data->pack_title}}">
                                        <input required type="hidden" name="pack_id" class="form-control" placeholder="Package Title" value = "{{$data->pack_id}}">
                                        <input required type="hidden" name="status" class="form-control" placeholder="Package Title" value = "{{$data->status}}">
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Origin </label>
                                        <div class="input-group">
                                            <input required class="form-control" name="origin" type="text" required value = "{{$data->origin}}" >
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Destination</label>
                                        <div class="input-group">
                                            <input required class="form-control" name="destination" value = "{{$data->destination}}" type="text" required>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Days </label>
                                        <div class="input-group">
                                            <input required class="form-control" name="days" type="text" required  value = "{{$data->days}}">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Nights</label>
                                        <div class="input-group">
                                            <input required class="form-control" name="nights" value = "{{$data->nights}}" type="text" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">Amount</label>
                                        <input required class="form-control" type="text" name="price" value = "{{$data->price}}">
                                    </div>

                                    <div class="col-12">
                                        <label class="form-label">Policies</label>
                                        <textarea required class="form-control" name='policy'>{{$data->policy}}</textarea>
                                    </div>

                                    <div class="col-12">
                                        <label class="form-label">Activities</label>
                                        <textarea required class="form-control" name='activity' >{{$data->activity}}</textarea>
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">Itinerary</label>
                                        <textarea required class="form-control" name='dayplaning'>{{$data->dayplanning}}</textarea>
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">Poster Images</label>
                                        <input class="form-control" type="file" name="poster_image">
                                        <input type="hidden" name="poster_image" value ="{{$data->poster_image}}" class="form-control">
                                        <img src="http://localhost:8000/img/package/@php echo $data['poster_image']; @endphp" style="height:200px; width:300px;">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input required class="form-control" name="start_date" type="text" value="{{$data->start_date}}" required>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input required class="form-control" name="end_date" type="text"
                                    ...
                                    <div class="row gy-3" id="dynamicAddRemove">
                                        ...
                                        <div class="col-md-10">                  
                                            <input placeholder="Service Name" name="image[]" type="file" class="form-control" value="">        
                                        </div>             
