  ...
  <div class="" style="width:100%;overflow:scroll">
    ...
    <tr>
      ...
      <tr>
        ...
        <td><a href="{{route('admin-user-blog-status',$item->post_id)}}" class="btn @php if($item['status'] == 'active'){echo"btn-success";}else{echo"btn-warning";} @endphp ">{{$item->status}}</a> </td>
      </tr>
    </div>
      @endforeach
    </table>
