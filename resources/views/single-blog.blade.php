                            ...
                            <div class="blog-post">
                                ...
                                <div class="blog-item">
                                    ...
                                    <div class="blog-post-body row margin-top-15">
                                        <div class="col-md-5">
                                            <img class="margin-bottom-20" src="{{url("img/blog/image1.jpg")}}" alt="image1">
                                        </div>
                                        <div class="col-md-7">
                                            <p>With a height of 1,381 feet, Menara Kuala Lumpur is just a little smaller than the famous Petronas Twin Towers. It was constructed in five phases starting in 1991 and finishing in 1996. Its main function is the use as a telecommunication tower for Malaysia and it is equipped with newest technology to meet the ever increasing requirements. It was built in the heart of Kuala Lumpur to provide a wider reception field in the area. If you are lucky, you can watch some base jumpers hopping from the tower.</p>
                                        </div>
                                        <div class="col-md-12">
                                            <p>
                                                You can visit the tower by going up the the observation deck with a glass front and glass bottom or to the open skydeck. Tickets are a lot easier to get compared to the popular Petronas Towers.
                                            </p>
                                            <blockquote class="primary">
                                                <p>
                                                    <em>"MENARA KUALA LUMPUR"</em>
                                                </p>
                                                <small>
                                                    Ramesh K
                                                    <cite title="Source Title">Patoliya</cite>
                                                </small>
                                            </blockquote>
                                    ...
                                    <div class="blog-item-footer">
                                        ...
                                        <div class="blog-author panel panel-default margin-bottom-30">
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <img class="pull-left" src="{{url('img/profiles/87.jpg')}}" alt="image1">
                                                    </div>
                                                    <div class="col-md-10">
                                            ...
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <div class="row">
                                                        <div class="col-md-2 profile-thumb">
                                                            <a href="#">
                                                                <img class="media-object" src="{{url('img/profiles/99.jpg')}}" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="col-md-10">
                                                            <h4>Great Article</h4>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="row">
                                                        <div class="col-md-2 profile-thumb">
                                                            <a href="#">
                                                                <img class="media-object" src="{{url('img/profiles/53.jpg')}}" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="col-md-10">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="row">
                                                        <div class="col-md-2 profile-thumb">
                                                            <a href="#">
                                                                <img class="media-object" src="{{url('img/profiles/37.jpg')}}" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="col-md-10">
                                                            <h4>Thank you!</h4>
                                ...
                                <ul class="posts-list margin-top-10">
                                    <li>
                                        <div class="recent-post">
                                            <a href="">
                                                <img class="pull-left" src="{{url('img/blog/thumbs/thumb1.jpg')}}" alt="thumb1">
                                            </a>
                                    ...
                                    <li>
                                        <div class="recent-post">
                                            <a href="">
                                                <img class="pull-left" src="{{url('img/blog/thumbs/thumb2.jpg')}}" alt="thumb2">
                                            </a>
                                            <a href="#" class="posts-list-title">Sidebar post example</a>
                                            <br>
                                            <span class="recent-post-date">
                                    ...
                                    <li>
                                        <div class="recent-post">
                                            <a href="">
                                                <img class="pull-left" src="{{url('img/blog/thumbs/thumb3.jpg')}}" alt="thumb3">
                                            </a>
                                            <a href="#" class="posts-list-title">Sidebar post example</a>
                                            <br>
                                            <span class="recent-post-date">
                                    ...
                                    <li>
                                        <div class="recent-post">
                                            <a href="">
                                                <img class="pull-left" src="{{url('img/blog/thumbs/thumb4.jpg')}}" alt="thumb4">
                                            </a>
                                            <a href="#" class="posts-list-title">Sidebar post example</a>
                                            <br>
                                            <span class="recent-post-date">
