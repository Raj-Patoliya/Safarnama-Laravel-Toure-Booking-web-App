                                   ...
                                   <div class="col-12">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input required class="form-control" name="origin" type="text" required  placeholder="Origin">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Destination</label>
                                        <div class="input-group">
                                            <input required class="form-control" name="destination" placeholder="Destination" type="text" required>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Days </label>
                                        <div class="input-group">
                                            <input required class="form-control" name="days" type="text" required  placeholder="Days..">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label">Nights</label>
                                        <div class="input-group">
                                            <input required class="form-control" name="nights" placeholder="Nights.." type="text" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">Amount</label>
                                        <input required class="form-control" type="text" name="price" placeholder="Amount Per Person..">
                                    </div>

                                    <div class="col-12">
                                        <label class="form-label">Policies</label>
                                        <textarea required class="form-control" name='policy'></textarea>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea required class="form-control" name='dayplaning'></textarea>
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label">Poster Images</label>
                                        <input required class="form-control" type="file" name="poster_image">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input required class="form-control" name="start_date" type="text"
