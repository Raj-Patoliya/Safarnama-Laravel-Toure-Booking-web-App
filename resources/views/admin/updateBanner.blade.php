        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Update Banner</h2>
                    </div>
                </div>
            </div>
        </div>

        <form action="{{ route('relevarch.admin.updateBanner', $banners->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
			@method('PATCH')
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input id="largeInput" name="bname" class="form-control form-control-lg"
                                                value="{{ $banners->bname }}" type="text" placeholder="Banner Name" />
                                        </div>
                                        @error('bname')
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input id="largeInput" name="bheading" class="form-control form-control-lg"
                                                value="{{ $banners->bheading }}" type="text" placeholder="Heading" />
                                        </div>
                                        @error('bheading')
                                ...
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-label-group">
                                                    <textarea class="form-control" name="bsub-heading"
                                                        ...
                                                        placeholder="Sub Heading">{{ $banners->bsubheading }}</textarea>
                                                </div>
                                            </div>
                                            @error('bsub-heading')
                                        ...
                                        <div class="col-sm-6 col-12">
                                            ...
                                            @error('image')
                                                <p class="text-danger">
                                                    {{ 'Image Dimensions Should be of 1600px X 900px only' }}</p>
                                            @enderror
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="dropdown">
                                            <button type="submit"
                                                class="btn btn-primary ag-grid-export-btn">Update</button>
