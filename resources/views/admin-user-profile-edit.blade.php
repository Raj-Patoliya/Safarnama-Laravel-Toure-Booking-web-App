                        ...
                        <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                            <form class="signup-page" method="POST" action="{{ route('insert.register')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-inline-input" type="radio" name="gender" id="inlineRadio1" value="male" @php
                                        if($data['gender'] == 'male')
                                        {
                                            echo "checked";
                                        }
                                    ...
                                    <input class="form-check-input" type="radio" name="gender" id="inlineRadio2" value="female" @php
                                ...
                                @endphp>
                                    ...
                                    <input class="form-check-input" type="radio" name="gender" id="inlineRadio3" value="other" @php
                                ...
                                @endphp>
                                  ...
                                  <div class="dropdown dropdownMenuLink margin-bottom-10">
                                      ...
                                      <select name="day" id="" class="btn btn-primary dropdown-toggle">
                                          <option  value=""><span class="dropdown-item">Date</span></option>
